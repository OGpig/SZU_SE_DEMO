...
class Canteen(models.Model):
    canteen_id = models.AutoField(primary_key=True, verbose_name='分区编号')
...
class Shop(models.Model):
    ...
    canteen = models.ForeignKey(Canteen, models.CASCADE, verbose_name='分区')
    manager = models.ForeignKey('ShopManager', models.SET_NULL, null=True, verbose_name='店铺经营者')
    shop_name = models.CharField(max_length=20, verbose_name='店铺名称')
    shop_detail = models.CharField(max_length=200, blank=True, null=True, verbose_name='店铺描述')
    shop_photo = models.ImageField(upload_to='images/shop', null=True, blank=True, verbose_name='店铺照片')
